 ...
 *
 * @see https://www.elastic.co/guide/en/beats/metricbeat/current/exported-fields-system.html#_process_9
 * @see https://github.com/elastic/integrations/blob/main/packages/system/data_stream/process/fields/fields.yml
 */
export const ATTR_SYSTEM_PROCESS_STATE = 'system.process.state' as const;

/**
 * The time when the process was started.
 *
 * @see https://www.elastic.co/guide/en/beats/metricbeat/current/exported-fields-system.html#_cpu_12
 * @see https://github.com/elastic/integrations/blob/main/packages/system/data_stream/process/fields/fields.yml
 */
export const METRIC_SYSTEM_PROCESS_CPU_START_TIME = 'system.process.cpu.start_time' as const;
 ...
 * @see https://github.com/elastic/integrations/blob/main/packages/system/data_stream/process/fields/fields.yml
 */
export const METRIC_SYSTEM_PROCESS_CPU_TOTAL_PCT = 'system.process.cpu.total.pct' as const;

/**
 * The percentage of memory the process occupied in main memory (RAM).
 *
 * @see https://www.elastic.co/guide/en/beats/metricbeat/current/exported-fields-system.html#_memory_13
 * @see https://github.com/elastic/integrations/blob/main/packages/system/data_stream/process/fields/fields.yml
 */
export const METRIC_SYSTEM_PROCESS_MEMORY_RSS_PCT = 'system.process.memory.rss.pct' as const;
